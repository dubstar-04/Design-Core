export class Utils {
    ...
    static cloneObject(core, obj) {
        ...
        //TODO: Cloned objects do not have access to class methods. to replicate, copy or move an already copied item
        ...
        var temp = core.commandManager.createNew(obj.type, undefined);
