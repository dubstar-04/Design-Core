...
static intersectLineCircle(line, circle, extend) {
    ...
    return intersectCircleLine(circle, line, extend)
...
static intersectArcRectangle(arc, rectangle, extend){
    ...
    var inter1 = this.intersectArcLine(arc, rectPoints, extend);

    rectPoints = {start: topRight, end: max}
    var inter2 = this.intersectArcLine(arc, rectPoints, extend);

    rectPoints = {start: max, end: bottomLeft}
    var inter3 = this.intersectArcLine(arc, rectPoints, extend);

    rectPoints = {start: bottomLeft, end: min}
    var inter4 = this.intersectArcLine(arc, rectPoints, extend);
...
static intersectArcLine(arc, line, extend){
    ...
    var inter1 = this.intersectCircleLine(arc, line, extend);
    var result = new Intersection("No Intersection");
...
static intersectLineArc(line, arc, extend){
    ...
    var inter1 = this.intersectCircleLine(arc, line);
    var result = new Intersection("No Intersection");
...
static intersectCircleArc(circle, arc, extend){
    ...
    var inter1 = this.intersectCircleCircle(circle, arc, extend);
    var result = new Intersection("No Intersection");
...
intersectArcCircle(arc, circle, extend){
    ...
    return intersectCircleArc(circle, arc, extend)
...
static intersectCircleRectangle(circle, rectangle, extend) {
    ...
    var rectPoints = {start: min, end: topRight}
    var inter1 = this.intersectCircleLine(circle, rectPoints);

    rectPoints = {start: topRight, end: max}
    var inter2 = this.intersectCircleLine(circle, rectPoints);

    rectPoints = {start: max, end: bottomLeft}
    var inter3 = this.intersectCircleLine(circle, rectPoints);

    rectPoints = {start: bottomLeft, end: min}
    var inter4 = this.intersectCircleLine(circle, rectPoints);
...
static intersectEllipsePolygon(c, rx, ry, points) {
    ...
    for ( var i = 0; i < length; i++ ) {
        ...
        var inter = this.intersectEllipseLine(c, rx, ry, b1, b2);
...
static intersectEllipseRectangle(ellipse, rectangle, extend) {
    ...
    var rectPoints = {start: min, end: topRight}
    var inter1 = this.intersectEllipseLine(ellipse, rectPoints);

    rectPoints = {start: topRight, end: max}
    var inter2 = this.intersectEllipseLine(ellipse, rectPoints);

    rectPoints = {start: max, end: bottomLeft}
    var inter3 = this.intersectEllipseLine(ellipse, rectPoints);

    rectPoints = {start: bottomLeft, end: min}
    var inter4 = this.intersectEllipseLine(ellipse, rectPoints);
...
static intersectPolylineLine(polyline, line, extend) {
    ...
    for ( var i = 0; i < length; i++ ) {
        ...
        var inter = this.intersectLineLine(line2, line, extend);
...
static intersectPolylineRectangle(polyline, rectangle, extend) {
    ...
    var rectPoints = {start: min, end: topRight}
    var inter1 = this.intersectPolylineLine(polyline, rectPoints, extend);

    rectPoints = {start: topRight, end: max}
    var inter2 = this.intersectPolylineLine(polyline, rectPoints, extend);

    rectPoints = {start: max, end: bottomLeft}
    var inter3 = this.intersectPolylineLine(polyline, rectPoints, extend);

    rectPoints = {start: bottomLeft, end: min}
    var inter4 = this.intersectPolylineLine(polyline, rectPoints, extend);
...
static intersectLineRectangle(line, rectangle, extend) {
    ...
    var rectPoints = {start: min, end: topRight}
    var inter1 = this.intersectLineLine(rectPoints, line, extend);

    rectPoints = {start: topRight, end: max}
    var inter2 = this.intersectLineLine(rectPoints, line, extend);

    rectPoints = {start: max, end: bottomLeft}
    var inter3 = this.intersectLineLine(rectPoints, line, extend);

    rectPoints = {start: bottomLeft, end: min}
    var inter4 = this.intersectLineLine(rectPoints, line, extend);
...
static intersectRectangleLine(rectangle, line, extend) {
    ...
    return intersectLineRectangle(line, rectangle, extend);
}
...
static intersectPolygonRectangle(points, r1, r2) {
    ...
    var inter1 = this.intersectLinePolygon(min, topRight, points);
    var inter2 = this.intersectLinePolygon(topRight, max, points);
    var inter3 = this.intersectLinePolygon(max, bottomLeft, points);
    var inter4 = this.intersectLinePolygon(bottomLeft, min, points);
...
static intersectRectangleRectangle(rectangle1, rectangle2, extend) {
    ...
    var rectPoints = {start: min, end: topRight}
    var inter1 = this.intersectLineRectangle(rectPoints, rectangle2);

    rectPoints = {start: topRight, end: max}
    var inter2 = this.intersectLineRectangle(rectPoints, rectangle2);

    rectPoints = {start: max, end: bottomLeft}
    var inter3 = this.intersectLineRectangle(rectPoints, rectangle2);

    rectPoints = {start: bottomLeft, end: min}
    var inter4 = this.intersectLineRectangle(rectPoints, rectangle2);
