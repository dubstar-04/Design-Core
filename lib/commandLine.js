export class CommandLine {
    ...
    handleKeys(e) {
		...
		console.log("char code", e.keyVal, e.keyCode)
    ...
    deletePressed(event) {
        ...
        core.designEngine.sceneControl('Enter', ['E'])
    ...
    enterPressed(event) {
        ...
        if (this.cmdLine.length > this.prompt.length) {
            ...
            var inputCommand = this.cmdLine.slice(this.prompt.length)
            console.log("[CommandLine.enterPressed] - Command:", inputCommand)
            var data = [inputCommand]
            //console.log(data[0])
            core.designEngine.sceneControl("Enter", data);
        } else {
            var data = [];
            core.designEngine.sceneControl("Enter", data);
        }
