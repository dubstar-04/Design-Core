...
export class DXF {
    ...
    static addElementToScene(type, data) {
        ...
        if (this.blockName !== "" || type == "Insert") {
            ...
            thisaddItemToBlock(type, data, name);
        } else {
        ...
        while (this.lineNum < this.lines.length) {
            ...
            switch (n) {
                case 0:
                    ...
                    if (name !== "") {
                        this.core.DSM.addStyle(dimstyle)
                    }
    ...
    static writeDXF(core) {
        ...
        data = data.concat(
            ...
            "\nLAYER",
            "\n70",
            "\n" + this.core.LM.layerCount())

        for (var i = 0; i < this.core.LM.layerCount(); i++) {
            data = data.concat("\n", this.core.LM.getLayerByIndex(i).dxf())
        }
        ...
        data = data.concat(
            ...
            "\nSTYLE",
            "\n70",
            "\n" + this.core.SM.styleCount())

        for (var i = 0; i < this.core.SM.styleCount(); i++) {
            data = data.concat("\n", this.core.SM.getStyleByIndex(i).dxf())
        }
        ...
        data = data.concat(
            ...
            "\nDIMSTYLE",
            "\n70",
            "\n" + this.core.DSM.styleCount())

        for (var i = 0; i < this.core.DSM.styleCount(); i++) {
            data = data.concat("\n", this.core.DSM.getStyleByIndex(i).dxf())
        }
