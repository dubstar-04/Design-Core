...
export class DXF {
    ...
    static writeDXF(core) {
        ...
        for (var i = 0; i < this.core.layerManager.layerCount(); i++) {
        ...
        for (var i = 0; i < this.core.styleManager.styleCount(); i++) {
        ...
        for (var i = 0; i < this.core.dimStyleManager.styleCount(); i++) {
