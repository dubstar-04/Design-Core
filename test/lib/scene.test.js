...
test('Test Scene.addEntity', () => {
  ...
  const returnIndex = scene.addEntity('FakeItem', {});
  ...
  const index = scene.addEntity('Line', { points: [new Point(), new Point(10, 10)] });
  ...
  scene.addEntity('Line', { points: [new Point(123, 123), new Point(321, 321)] }, index);
  expect(scene.entities.count()).toBe(itemCount + 1);
