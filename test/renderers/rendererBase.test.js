...
describe('RendererBase.Styles', () => {
  test('NONE returns colour unchanged', () => {
    expect(RendererBase.Styles.NONE({ r: 100, g: 150, b: 200 }))
      .toEqual({ r: 100, g: 150, b: 200 });
  });

  test('MONOCHROME returns black for any colour', () => {
    expect(RendererBase.Styles.MONOCHROME({ r: 255, g: 128, b: 0 }))
      .toEqual({ r: 0, g: 0, b: 0 });
  });

  test('MONOCHROME returns black even for white', () => {
    expect(RendererBase.Styles.MONOCHROME({ r: 255, g: 255, b: 255 }))
      .toEqual({ r: 0, g: 0, b: 0 });
  });

  test('GREYSCALE produces equal r/g/b channels', () => {
    const result = RendererBase.Styles.GREYSCALE({ r: 255, g: 0, b: 0 });
