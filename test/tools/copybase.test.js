...
import { Copybase } from '../../core/tools/copybase.js';
...
describe('Copybase Tool', () => {
  ...
  test('action copies selected entities and sets base point to user-provided point', () => {
    ...
    const tool = new Copybase();
    tool.points.push(new Point(10, 11)); // set base point
    tool.action();
    ...
    expect(DesignCore.Clipboard.BasePoint.y).toBe(11);
  });
