...
test('Test propertyManager.getItemTypes', () => {
  ...
  core.scene.selecting.selectionSet.push(0);
  ...
  core.scene.selecting.selectionSet.push(1);
  types = propertiesManager.getItemTypes();
...
test('Test propertyManager.setItemProperties', () => {
  ...
  core.scene.reset();
  // add the text entity
  core.scene.selecting.selectionSet.push(2);
...
test('Test propertyManager.getItemPropertyValue', () => {
  ...
  core.scene.selecting.selectionSet.push(3);
